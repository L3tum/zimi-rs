...
//!
//! Explicit-ID lookups (fetching one named article's indexed metadata, e.g.
//! [`crate::db::articles::fetch_article_snippet`]) are not random draws and
//! live in [`crate::db::articles`].
